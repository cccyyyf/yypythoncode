...
@allure.feature("场景：添加独立行业设备(1.添加监测量->2.添加区域/站点->3.添加行业设备模板->4.添加iot设备->5.添加行业设备->6.删除行业设备、删除行业设备模板、站点、监测量等")
class TestaddIndustrySingleDevice(DsStationPO,DsPointPO,DsIndustryTemplatePO,DsIndustryDevicePO,DsIotDevicePO,DsIotTemplatePO):
    ...
    @allure.story("1.添加监测量->2.添加区域/站点->3.添加行业设备模板->4.添加行业设备->5.删除行业设备、删除行业设备模板、站点、监测量")
    def test_addIndustrySingleDevice(self):
        #添加监测量
        body_point = {
