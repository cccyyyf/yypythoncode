...
@allure.feature("场景：添加Fbox iot设备(1.添加监测量->2.添加区域/站点->3.添加iot模板(fbox)->4.添加iot设备(有子设备)->5.删除iot设备、删除iot模板、站点、监测量")
class TestaddIotFboxDevice(DsStationPO,DsPointPO,DsIotTemplatePO,DsIotDevicePO):
    ...
    @allure.story("1.添加监测量->2.添加区域/站点->3.添加iot模板(fbox)->4.添加iot设备(有子设备)->5.删除iot设备、删除iot模板、站点、监测量")
    def test_addIotFboxDevice(self):
        #添加监测量
        body_point = {
