...
@allure.feature("场景：添加gateway iot设备(1.添加监测量->2.添加区域/站点->3.添加iot模板(gateway)->4.添加iot设备(无子设备)->5.删除iot设备、删除iot模板、站点、监测量")
class TestaddIotGatewayDevice(DsStationPO,DsPointPO,DsIotTemplatePO,DsIotDevicePO):
    ...
    @allure.story("1.添加监测量->2.添加区域/站点->3.添加iot模板(gateway)->4.添加iot设备(无子设备)->5.删除iot设备、删除iot模板、站点、监测量")
    def test_addIotGatewayDevice(self):
        #添加监测量
        body_point = {
