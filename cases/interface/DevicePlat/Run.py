...
conf = ConfigUtil(RootPath.getDevicePlatPath()+'/DevicePlat.ini')
case_path = os.path.dirname(RootPath.getDevicePlatPath()).replace("resources", "cases")
report_path = os.path.dirname(RootPath.getDevicePlatPath()).replace("resources", "reports")
